...
- **Verifiers**: Configure signature verification (Notation, Cosign, etc.)
- **Stores**: Define how to access artifacts
...
The Cosign verifier supports both keyless signature verification with scoped trust policies.
