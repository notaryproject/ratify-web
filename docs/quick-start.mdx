...
For production use or if you prefer manual installation without helmfile automation, please refer to [ratify-quickstart-manual.md](quickstarts/quickstart-manual.md) for step-by-step instructions.
